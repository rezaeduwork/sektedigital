...
<body class="bg-gray-100 flex flex-col items-center justify-center h-screen text-center">
    <div class="max-w-md">
        ...
        <h1 class="text-4xl font-bold text-primary mt-6">Oops! Halaman Tidak Ditemukan</h1>
        <p class="text-gray-600 mt-4">Sepertinya halaman yang Anda cari tidak tersedia atau telah dipindahkan.</p>
        <a href="{{url('/')}}" class="mt-6 inline-block px-6 py-3 bg-primary text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition">
            Kembali ke Beranda
        </a>
    </div>
</body>
