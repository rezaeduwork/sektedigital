          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                Rp{{number_format(\App\Models\Transaction::sum('amount'),0,',','.')}}
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{\App\Models\Transaction::whereStatus('finished')->count()}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{\App\Models\Store::count()}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
