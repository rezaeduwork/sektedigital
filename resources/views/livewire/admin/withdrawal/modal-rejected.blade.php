<div>
  <button data-toggle="modal" data-target="#show-deleted-modal" class="btn btn-secondary btn-sm">Rejected Withdrawal ({{\App\Models\UserBalance::whereType('withdraw')->whereStatus('rejected')->count()}})</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Rejected Withdrawal</h5>
