<div>
  <a href="#update-modal-{{$category->id}}" data-toggle="modal" class="btn btn-xs btn-secondary">Update</a>
  <!-- Modal -->
  <div class="modal fade" id="update-modal-{{$category->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
