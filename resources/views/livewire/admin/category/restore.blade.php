<div>
  <button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#restore-modal-{{$category->id}}">Restore</button>
  <div class="modal fade" id="restore-modal-{{$category->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
