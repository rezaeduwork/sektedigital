<div class="mb-5 container max-sm:mt-[3rem] max-sm:pb-[4rem]">
  ...
  <div class="flex items-start flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4" x-data="{withdrawOpen: false, depositOpen: false}" @alert-success.window="withdrawOpen = false; depositOpen = false">
    <div class="shrink-0 w-full sm:w-[280px] space-y-4">
      <div class="py-2 px-4 bg-white shadow rounded items-center sm:py-4 sm:bg-white sm:rounded-lg sm:shadow sm:px-4 sm:pb-4">
        <div class="flex space-x-4 items-center">
          ...
          <div class="w-full">
            ...
            <div class="flex items-center space-x-2">
              ...
              <button wire:click="reloadUserBalance" wire:loading.attr="disabled" class="text-gray-500 hover:text-primary transition-colors" title="Refresh saldo">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" wire:loading.remove wire:target="reloadUserBalance" class="w-5 h-5">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
                </svg>
                <span wire:loading wire:target="reloadUserBalance" class="inline-block">
        ...
        <div class="flex flex-col space-y-2 md:flex-row md:space-x-2 md:space-y-0 text-white">
          <button class="bg-primary py-2 w-full rounded" @click="depositOpen = true">Deposit</button>
      ...
      <template x-teleport="body">
        @include('livewire.user.wallet.deposit-modal')
      </template>
