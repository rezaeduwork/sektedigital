<div>
  ...
  <div class="mb-5">
    ...
    {{-- <input type="email" id="email" disabled class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-300 focus:border-violet-300 block w-full p-2.5" placeholder="" required /> --}}
    <div>{{auth()->user()->email}}</div>
  </div>
  <div class="mb-5">
    <label for="phone" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Nomor HP</label>
    <input type="number" wire:model.live.debounce.250ms="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-300 focus:border-violet-300 block w-full p-2.5" placeholder="" required />
    @error('phone')
    <small class="text-primary">{{$message}}</small>
    @enderror
  </div>
  ...
  <div class="mb-5">
    ...
    <input type="date" id="birthdate" wire:model.live.debounce.250ms="birthdate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-300 focus:border-violet-300 block w-full p-2.5" placeholder="" required />
    @error('birthdate')
    <small class="text-primary">{{$message}}</small>
    @enderror
  </div>
  <div class="mb-5">
    ...
    <textarea id="address" wire:model.live.debounce.250ms="address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-300 focus:border-violet-300 block w-full p-2.5"
