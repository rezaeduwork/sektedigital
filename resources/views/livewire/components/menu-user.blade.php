<div class="space-y-4 p-4">
  ...
  <div class="mb-4">
    ...
    <div class="grid grid-cols-3 gap-2">
      ...
      <div class="flex flex-col items-center justify-center space-y-2 border shadow p-4 rounded cursor-pointer" @click="Livewire.navigate('{{url('user/transaction')}}?tab={{'processed'}}')">
      ...
      <div class="flex flex-col items-center justify-center space-y-2 border shadow p-4 rounded cursor-pointer" @click="Livewire.navigate('{{url('user/transaction')}}?tab={{'finished'}}')">
  ...
  <div class="grid gap-2">
    ...
    <a href="{{url('user/profile')}}" wire:navigate class="flex items-center gap-3 rounded-md py-2 px-3 col-span-12 border shadow">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
      </svg>
      <span>Akun Saya</span>
    </a>
    <a href="{{url('store')}}" class="flex items-center gap-3 rounded-md py-2 px-3 border shadow relative col-span-6">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349M3.75 21V9.349m0 0a3.001 3.001 0 0 0 3.75-.615A2.993 2.993 0 0 0 9.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 0 0 2.25 1.016c.896 0 1.7-.393 2.25-1.015a3.001 3.001 0 0 0 3.75.614m-16.5 0a3.004 3.004 0 0 1-.621-4.72l1.189-1.19A1.5 1.5 0 0 1 5.378 3h13.243a1.5 1.5 0 0 1 1.06.44l1.19 1.189a3 3 0 0 1-.621 4.72M6.75 18h3.75a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75H6.75a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75Z" />
      </svg>
      <span>Toko Saya</span>
    </a>
    <a href="#" class="flex items-center gap-3 rounded-md py-2 px-3 border shadow col-span-6">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
