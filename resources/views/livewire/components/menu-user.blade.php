<div class="space-y-4 p-4">
  ...
  <div class="grid gap-2">
    ...
    @endif
    @endauth
    <a href="{{url('user/profile')}}" wire:navigate class="flex items-center gap-3 rounded-md py-2 px-3 col-span-12 border hover:shadow">
    ...
    <a href="#" class="flex items-center gap-3 rounded-md py-2 px-3 border hover:shadow col-span-6">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
