  ...
  <div class="bg-primary text-white">
    ...
    <div class="container max-w-[968px] mx-auto">
      <div class="flex justify-between items-center py-2">
        <div class="flex">
          <div class="selectBox">
            <a class="selectValue text-reset text-xs lg:text-sm" href="javascript:void(0)" aria-expanded="false">Tentang
              Sekte Digital</a>
          </div>
          <div class="ms-6">
            <div class="selectBox">
              <a class="selectValue text-reset text-xs lg:text-sm" href="javascript:void(0)" aria-expanded="false">Mulai
                Berjualan</a>
            </div>
          </div>
        </div>
        ...
        <div class="md:flex items-center justify-end">
          <div class="flex items-center space-x-5">
            ...
            <div class="text-reset flex items-center space-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currentColor" class="bi bi-instagram"
                viewBox="0 0 16 16">
                <path
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currentColor" class="bi bi-whatsapp"
                viewBox="0 0 16 16">
                <path
      ...
      <div class="flex items-center justify-center md:justify-start shrink-0 space-x-4">
        ...
        <div class="dropdown hidden lg:block">
          <button class="mr-0 btn !p-2 inline-flex items-center gap-x-2 text-gray-600" type="button"
            ...
            <span>
              <svg xmlns="../www.w3.org/2000/svg.html" class="icon icon-tabler icon-tabler-layout-grid" width="24"
          ...
          <ul class="dropdown-menu dropdown-menu-lg">
            <li class="dropdown-menu-list">
              <a href="javascript:void(0)" class="dropdown-item mb-1 py-1 flex justify-between">
                <div>
                  <svg width="24" height="24" viewBox="0 0 56 56" class="inline-block" fill="#3d4f58"
                ...
                <div>
                  <svg xmlns="../www.w3.org/2000/svg.html" width="16" height="16" viewBox="0 0 24 24"
        ...
        <div class="flex items-center justify-end space-x-5 mx-1">
          ...
          <div class="text-center">
            <a
              ...
              <div class="text-center flex items-center">
                <div class="m-auto inline-block relative">
                  <svg xmlns="../www.w3.org/2000/svg.html" width="24" height="24"
                    class="icon icon-tabler icons-tabler-outline icon-tabler-brand-hipchat" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
