<nav
    class="!p-0 lg:!py-2 lg:!px-4 navbar relative navbar-expand-lg flex lg:hidden lg:flex-wrap items-center content-between text-black navbar-profile"
    aria-label="Offcanvas navbar large">
    <div class="container max-w-7xl mx-auto w-full lg:px-0">
      <div class="offcanvas offcanvas-left lg:visible" tabindex="-1" id="navbar-profile">
        <div class="offcanvas-body lg:flex lg:items-center space-y-4">
          ...
          <div class="mb-4">
            ...
            <div class="grid grid-cols-3 gap-2">
              <div class="flex flex-col items-center justify-center space-y-2 border shadow p-4 rounded">
          ...
          <button class="flex justify-center gap-3 rounded-md bg-red-600 py-2 px-3 font-semibold hover:bg-red-500 focus:ring-2 focus:ring-red-400 text-white w-full">
