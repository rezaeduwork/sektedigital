<div class="w-full space-y-4">
  ...
  <ul>
    ...
    <li>
      ...
      <ul id="dropdown-{{$id}}" class="py-2 space-y-2">
        ...
        <li>
          <a href="{{$rowSub["url"]}}"
            wire:navigate
            class="
            flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:font-bold hover:text-primary
      ...
      flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:font-bold hover:text-primary
