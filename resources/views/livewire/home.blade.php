<div>
  <section class="mb-4">
    <div class="container">
      <img src="{{url('storage/baner.png')}}" alt="" srcset="" class="w-full h-auto max-h-[300px] object-cover object-top">
    </div>
  </section>
  ...
  <div class="lg:mb-14 mb-8">
    ...
    <div class="container">
      ...
      <div class="grid grid-cols-12 gap-6">
        <!-- col -->
        {{-- <aside class="xl:col-span-3 lg:col-span-4 md:col-span-4">
          <div id="sidebar">
            <div class="sidebar__inner">
              <div class="offcanvas offcanvas-left offcanvas-collapse" id="offcanvasCategory"
                ...
                <div class="offcanvas-body p-lg-0">
                  <div class="mb-4">
                    <!-- title -->
                    <h3 class="mb-4 text-md gap-2">Categories</h3>
                    <!-- nav -->
                    <div class="card">
                      <ul class="nav nav-category" id="categoryCollapseMenu">
                        <li class="nav-item border-b border-gray-300 w-full collapsed px-4 py-1">
                          <a href="javascript:void(0)" class="nav-link" data-bs-toggle="collapse"
                            ...
                            <svg xmlns="../www.w3.org/2000/svg.html" width="16" height="16" viewBox="0 0 24 24"
                              ...
                              class="inline-block icon icon-tabler icons-tabler-outline icon-tabler-chevron-right">
                              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                          ...
                          <div id="categoryFlushOne" class="accordion-collapse collapse"
                            ...
                            <div>
                              ...
                              <ul class="nav flex-col ms-8">
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Milk</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Milk Drinks</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Curd & Yogurt</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Eggs</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Bread</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Buns & Bakery</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Butter & More</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Cheese</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Paneer & Tofu</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Cream & Whitener</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Condensed Milk</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Vegan Drinks</a>
                                </li>
                              </ul>
                            </div>
                          </div>
                        ...
                        <li class="nav-item border-b border-gray-300 w-full collapsed px-4 py-1">
                          <a href="javascript:void(0)" class="nav-link" data-bs-toggle="collapse"
                            ...
                            <svg xmlns="../www.w3.org/2000/svg.html" width="16" height="16"
                          ...
                          <div id="flush-collapseTwo" class="accordion-collapse collapse"
                            ...
                            <div>
                              <ul class="nav flex-col ms-8">
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Chips & Crisps</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Nachos</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Popcorn</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Bhujia & Mixtures</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Namkeen Snacks</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Healthy Snacks</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Cakes & Rolls</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Energy Bars</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Papad & Fryums</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Rusks & Wafers</a>
                                </li>
                              </ul>
                            </div>
                          </div>
                          ...
                          <div id="flush-collapseThree" class="accordion-collapse collapse"
                            ...
                            <div>
                              <ul class="nav flex-col ms-8">
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a class="nav-link active" aria-current="page" href="javascript:void(0)">Fresh
                                    Vegetables</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                          ...
                          <div id="flush-collapseFour" class="accordion-collapse collapse"
                            ...
                            <div>
                              <ul class="nav flex-col ms-8">
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Soft Drinks</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Fruit Juices</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Coldpress</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Energy Drinks</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Water & Ice Cubes</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Soda & Mixers</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Concentrates & Syrups</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Detox & Energy Drinks</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link">Juice Collection</a>
                                </li>
                              </ul>
                            </div>
                          </div>
                          ...
                          <div id="flush-collapseFive" class="accordion-collapse collapse"
                            ...
                            <div>
                              <ul class="nav flex-col ms-8">
                                <!-- nav item -->
                                <li class="nav-item">
                                  <a class="nav-link active" aria-current="page" href="javascript:void(0)">Diapers,
                                    Wipes & More</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item">
                        ...
                        <li class="nav-item w-full collapsed px-4 py-1">
                          <a href="javascript:void(0)" class="nav-link" data-bs-toggle="collapse"
    ...
    <div class="container">
      <div class="grid grid-cols-12 items-center mb-8">
        <div class="md:col-span-8 col-span-12">
          ...
          <div class="flex">
            <div class="mt-1">
              <svg xmlns="../www.w3.org/2000/svg.html" width="32" height="32" viewBox="0 0 24 24"
                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <div class="col-span-12 md:col-span-6 lg:col-span-3 mb-8">
          <div class="mb-4">
            <a href="#!">
              <!-- img -->
              <div class="img-zoom">
                <img src="{{ url('/') }}/assets/images/blog/blog-img-1.jpg" alt=""
                  class="rounded-3" />
              </div>
            </a>
          </div>
          ...
          <div>
            ...
            <div class="flex items-center mt-4">
              <svg xmlns="../www.w3.org/2000/svg.html" width="14" height="14" viewBox="0 0 24 24"
                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="col-span-12 md:col-span-6 lg:col-span-3 mb-8">
          <div class="mb-4">
            <a href="#!">
              <div class="img-zoom">
                <!-- img -->
                <img src="{{ url('/') }}/assets/images/blog/blog-img-2.jpg" alt=""
                  class="rounded-3" />
              </div>
            </a>
          </div>
        ...
        <div class="col-span-12 md:col-span-6 lg:col-span-3 mb-8">
          <div class="mb-4">
            <a href="#!">
              <!-- img -->
              <div class="img-zoom">
                <img src="{{ url('/') }}/assets/images/blog/blog-img-3.jpg" alt=""
                  class="rounded-3" />
              </div>
            </a>
          </div>
        ...
        <div class="col-span-12 md:col-span-6 lg:col-span-3 mb-8">
          <div class="mb-4">
            <a href="#!">
              <!-- img -->
              <div class="img-zoom">
                <img src="{{ url('/') }}/assets/images/blog/blog-img-4.jpg" alt=""
                  class="rounded-3" />
              </div>
            </a>
          </div>
