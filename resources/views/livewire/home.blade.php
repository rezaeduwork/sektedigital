<div class="mt-[3rem] lg:mt-[102px]">
  <div class="h-[400px] relative mb-4 sm:mb-8">
    ...
    <div class="relative z-[10] text-white max-w-[968px] mx-auto h-full">
      <div class="container h-full flex flex-col justify-center">
        ...
        <div class="mt-[32px] flex items-center max-sm:justify-center max-sm:w-full space-x-2">
          <button type="button" data-bs-toggle="modal" data-bs-target="#userModal" class="bg-white text-primary rounded text-[16px] px-4 py-2 max-sm:text-xs sm:px-5 sm:py-3 font-bold flex items-center justify-center space-x-2">
