<section class="container" x-data="{ searchCategory: '' }">
  <div class="flex flex-col items-center justify-between md:flex-row w-full mb-5">
    <h1 class="text-2xl font-bold mb-5 md:mb-0">
      <div>Buat Dagangan Baru</div>
    </h1>
    <a href="{{ url('/store/product') }}" wire:navigate
  ...
  <div class="table-responsive-xl p-6 mb-6 mb-lg-0 space-y-4  bg-white rounded border">
    ...
    <div class="mb-5">
      ...
      <ul class="text-gray-500 my-2 text-xs">
    ...
    <div class="mb-5">
      ...
      <input id="price" wire:model.live.debounce.250ms="price" min="1" max="1000000000" type="number"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-300 focus:border-violet-300 block w-full p-2.5"
        placeholder="">
