<div id="toast-warning" @alert-warning.window="openToast('warning',$event)"
:class="open == 'warning' ? '!flex animate-slideUp':''"
style="display: none;"
wire:ignore
class="fixed flex right-0 bottom-[39px] max-sm:-translate-x-[3%] sm:bottom-0 items-center w-[95%] sm:max-w-xs p-4 mb-4 text-white bg-yellow-400 rounded-lg shadow z-[9999]" role="alert">
